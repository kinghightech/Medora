...
final class LocalizationManager: ObservableObject {
    ...
    private static let translations: [AppLanguage: [String: String]] = [
        .spanish: [
            ...
            "e.g. Diabetes, Cancer, Asthma": "ej. Diabetes, Cáncer, Asma",
            "No active clinical trials found for '%@'. Please check your spelling or try another term.": "No se encontraron ensayos clínicos activos para '%@'. Verifique la ortografía o intente con otro término.",
            "miles": "millas",
            "No trials found": "No se encontraron ensayos",
        ],
        .french: [
            "Home": "Accueil",
            "Checklist": "Liste",
            ...
            "e.g. Diabetes, Cancer, Asthma": "ex. Diabète, Cancer, Asthme",
            "No active clinical trials found for '%@'. Please check your spelling or try another term.": "Aucun essai clinique actif trouvé pour '%@'. Veuillez vérifier l'orthographe ou essayer un autre terme.",
            "miles": "milles",
            "No trials found": "Aucun essai trouvé",
        ],
        .german: [
            "Home": "Start",
            ...
            "Medical Condition": "Medizinische Verfassung",
            "Search Radius": "Suchradius",
            "Use Current Location": "Aktuellen Standort verwenden",
            "e.g. Diabetes, Cancer, Asthma": "z.B. Diabetes, Krebs, Asthma",
            "No active clinical trials found for '%@'. Please check your spelling or try another term.": "Keine aktiven klinischen Studien für '%@' gefunden. Bitte überprüfe die Schreibweise oder versuche einen anderen Begriff.",
            "miles": "Meilen",
            "No trials found": "Keine Studien gefunden",
        ],
        .chinese: [
            "Home": "主页",
            "Checklist": "清单",
        ...
        .hindi: [
            ...
            "Heart Rate": "दिल की धड़कन",
            "Blood Pressure": "रक्तचाप",
            "Blood Glucose": "ब्लड शुगर",
            "Medications": "दवाएं",
